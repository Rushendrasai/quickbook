...
export class Backend implements backendInterface {
    ...
    async addBooking(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addBooking(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getBookedSlots(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookedSlots(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
